...
export default class SpellSheet extends KitchenSinkDocumentSheet {

    /** @override */
    static get defaultOptions() {
        return foundry.utils.mergeObject(super.defaultOptions, {
            classes: ["kitchen-sink", "sheet", "handlebars-sheet", "item", "spell-sheet"],
            tabs: [
    ...
    async getData() {
        ...
        context.typeChoices = {
            Attack: "Spell.Type.Attack",
            Defense: "Spell.Type.Defense",
            Healing: "Spell.Type.Healing",
        };
        context.classChoices = {
            Fire: "Spell.Class.Fire",
            Water: "Spell.Class.Water",
            Earth: "Spell.Class.Earth",
            Air: "Spell.Class.Air",
        };
        return context;
    }
