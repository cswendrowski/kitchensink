       ...
       import { PotionItemApp } from "../components/components.vue.es.mjs";
       import KitchenSinkRoll from "../../../rolls/roll.mjs";
       const { DOCUMENT_OWNERSHIP_LEVELS } = CONST;

       export default class PotionVueSheet extends VueRenderingMixin(foundry.applications.sheets.ItemSheetV2) {
           ...
           vueParts = {
               "potion-item-app": {
                   component: PotionItemApp,
                   template: "<potion-item-app :context=\"context\">Vue rendering for sheet failed.</potion-item-app>"
               }
           };
           ...
           static DEFAULT_OPTIONS = {
               classes: ["kitchen-sink", "sheet", "vue-sheet", "item", "potion-sheet"],
           ...
           async _onAction(event) {
               ...
               switch ( action ) {
                   case "use": this._onUseAction(event, this.document.system); break;
               }
           }
