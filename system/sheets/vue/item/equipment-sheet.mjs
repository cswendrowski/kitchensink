       ...
       import { EquipmentItemApp } from "../components/components.vue.es.mjs";
       import KitchenSinkRoll from "../../../rolls/roll.mjs";
       const { DOCUMENT_OWNERSHIP_LEVELS } = CONST;

       export default class EquipmentVueSheet extends VueRenderingMixin(foundry.applications.sheets.ItemSheetV2) {
           ...
           vueParts = {
               "equipment-item-app": {
                   component: EquipmentItemApp,
                   template: "<equipment-item-app :context=\"context\">Vue rendering for sheet failed.</equipment-item-app>"
               }
           };
           ...
           static DEFAULT_OPTIONS = {
               classes: ["kitchen-sink", "sheet", "vue-sheet", "item", "equipment-sheet"],
