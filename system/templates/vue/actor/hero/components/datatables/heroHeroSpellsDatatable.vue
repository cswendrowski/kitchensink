<script setup>
    ...
    const columns = [
        ...
        { data: 'system.type.value', title: game.i18n.localize("Spell.Type"), type: 'string' },
        { data: 'system.class.value', title: game.i18n.localize("Spell.Class"), type: 'string' },
        { 
            data: null,
...
<template>
    <DataTable class="display compact" :data="data" :columns="columns" :options="options" @draw="bindDragDrop">
        ...
        <template #actions="props">
            <div class="flexrow">
                <a class="row-action" data-action="roll" @click="customItemAction(props.rowData, $event)" :data-tooltip="game.i18n.localize('Roll')"><i class="fas fa-solid fa-bolt" style="color: #000000;"></i></a>
