<script setup>
    ...
    const columns = [
        ...
        { data: 'system.quantity', title: game.i18n.localize("Potion.Quantity"), type: 'num' },
        { 
            data: null,
...
<template>
    <DataTable class="display compact" :data="data" :columns="columns" :options="options" @draw="bindDragDrop">
        ...
        <template #actions="props">
            <div class="flexrow">
                <a class="row-action" data-action="use" @click="customItemAction(props.rowData, $event)" :data-tooltip="game.i18n.localize('Use')"><i class="fas fa-solid fa-flask-round-potion" style="color: #000000;"></i></a>
