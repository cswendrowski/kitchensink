...
<template>
    <v-btn :color="color" class="action-btn" @click="onClick" v-if="!hidden" :disabled="disabled"  :data-tooltip="game.i18n.localize('Skill.Roll')">{{game.i18n.localize('Skill.Roll')}}</v-btn>
</template>
